...
const icons = {
  ...
  keyframes: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.75,6.25v2.5l3.5-3.5-3.5-3.5v2.5h-10V1.75l-3.5,3.5,3.5,3.5V6.25h10Zm2,4h-2v12h2v-12Zm-14,0v12h2v-12h-2Zm6,0v12h2v-12h-2Z"/><path d="M0,0H24V24H0V0Z" fill="none"/></svg>',
  ...
  wholeNumbers: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><path d="M4,13a8,8,0,0,0,16,0H18a6,6,0,1,1-6-6v4l5-5L12,1V5A8,8,0,0,0,4,13Zm6.73,3.12H9.82V12.79l-0.31.3L9,13.48,8.6,12.94,10,11.84h0.74v4.28Zm0.69-.42a0.49,0.49,0,0,1,.13-0.37,0.53,0.53,0,0,1,.38-0.13,0.52,0.52,0,0,1,.38.13,0.57,0.57,0,0,1,0,.73,0.51,0.51,0,0,1-.37.13,0.53,0.53,0,0,1-.38-0.13A0.49,0.49,0,0,1,11.42,15.7Zm4-1.72A3,3,0,0,1,15,15.64a1.27,1.27,0,0,1-1.13.54,1.26,1.26,0,0,1-1.12-.56A2.94,2.94,0,0,1,12.4,14a3,3,0,0,1,.37-1.67,1.27,1.27,0,0,1,1.13-.54,1.26,1.26,0,0,1,1.12.56A3,3,0,0,1,15.4,14ZM13.3,14a3.34,3.34,0,0,0,.14,1.13,0.48,0.48,0,0,0,.92,0A3.24,3.24,0,0,0,14.49,14a3.23,3.23,0,0,0-.14-1.13,0.47,0.47,0,0,0-.91,0A3.33,3.33,0,0,0,13.3,14Z"/></svg>'
};
